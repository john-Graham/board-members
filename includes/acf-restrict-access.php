 ...
 */
// add_filter( 'acf/settings/show_admin', 'coe_boards_show_acf_admin' );
/**
 * Filters the settings to pass to the block editor for all editor type.
 * @link https://developer.wordpress.org/reference/hooks/block_editor_settings_all/
 */
// add_filter( 'block_editor_settings_all', 'coe_boards_restrict_locking_ui', 10, 2 );
 ...
 * @since 0.1.2
 */
// function coe_boards_show_acf_admin() {
...
// 	$settings['canLockBlocks'] = coe_boards_show_admin();
